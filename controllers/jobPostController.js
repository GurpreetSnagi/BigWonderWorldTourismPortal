  ...
  */
  ...
  const myPostingsView = async (req, res) => {
    try {
        ...
        const carPostings =  await Car.find({ creatorEmail: email });
        //console.log(jobPostings)
        console.log(hotelPostings)
        res.render("viewMyPostings", {
          hotelPostings: hotelPostings,
          carPostings: carPostings,
            user: req.user
        });
      } catch (error) {
        console.error(error);
  ...
  const deletePosting = async (req, res) => {
    try {
        const result =  await Hotel.deleteOne({ id: req.query.id });
        console.log(result);
        res.render("jobPostSuccess", {
